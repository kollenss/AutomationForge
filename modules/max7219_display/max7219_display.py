        ...
        'params': [
            {
                ...
                'description': 'Which 2-digit block to write to. The display has 8 digits = 4 pairs. E.g. Pair 0 = the two leftmost digits.',
            },
            {'key': 'intensity', 'label': 'Brightness (0-15)', 'type': 'number',
             'default': 8, 'min': 0, 'max': 15,
             'description': 'Display brightness from 0 (dimmest) to 15 (brightest). E.g. 8.'},
            {'key': 'name', 'label': 'Label', 'type': 'text', 'default': 'display',
             'description': 'Display name shown on the card. E.g. display.'},
        ],
        'inputs': [
